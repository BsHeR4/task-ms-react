...
import inputs from '../../consts/RegisterInputs'
                ...
                loading ? (
                    ...
                    <>
                        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                            ...
                            <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Register a new account to get access</h2>
                        </div>
                        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            <Form inputs={inputs} submitTitle={"Registre"} dataHandle={handleLogin} />
